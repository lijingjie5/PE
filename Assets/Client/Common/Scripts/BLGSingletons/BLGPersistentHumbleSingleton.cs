...
namespace BLG
{
	...
	/// </summary>
	public class BLGPersistentHumbleSingleton<T> : MonoBehaviour	where T : Component
	{
		...
		protected virtual void Awake ()
		{
			...
			foreach (T searched in check)
			{
				if (searched!=this)
				{
					...
					if (searched.GetComponent<BLGPersistentHumbleSingleton<T>>().InitializationTime<InitializationTime)
					{
